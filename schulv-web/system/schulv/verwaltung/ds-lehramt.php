...
class schulvDatasourceVerwaltungLehraemter extends controlDatasource {
	var $attribs;
	var $ldap_result;
	var $pos;

	function schulvDatasourceVerwaltungLehraemter($argv) {
		$this->controlDatasource($argv);
		$this->pos = 0;
		$this->attribs = array("kuerzel", "description", "bereich");
	}
